-- Adds the shooter's current handicap to shooter_stats_for_season, so the
-- League Table page can show it alongside the season stats (mirrors the
-- `handicap` column already on the shooter_stats view, see 2026-07-04-handicap.sql).
